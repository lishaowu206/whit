...
namespace TestStack.White.UIItems
{
    ...
    public class UIItem : IUIItem
    {
        ...
        public virtual void LogStructure()
        {
            ...
            string filePath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory,"log.txt");
            Logger.Info("Output details to file: " + filePath);
            // Output details to file.          
            System.IO.File.AppendAllText(filePath, Debug.Details(AutomationElement),System.Text.Encoding.Default);
        }
