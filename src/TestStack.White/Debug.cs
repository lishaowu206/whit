...
namespace TestStack.White
{
    public static class Debug
    {
        ...
        public static string Details(AutomationElement automationElement)
        {
            try
            {
                AutomationIdList = new List<string>();
                var stringBuilder = new StringBuilder();
                //stringBuilder.AppendLine("ID(control name),Name(control content),BoundingRectangle(control pixel)");
        ...
        static List<string> AutomationIdList;
        private static void WriteDetail(AutomationElement automationElement, StringBuilder stringBuilder, string displayPadding)
        {
           ...
           // WriteDetail(stringBuilder, "ClassName: " + automationElement.Current.ClassName, displayPadding);
            ...
            //WriteDetail(stringBuilder,  automationElement.Current.AutomationId + ","+ automationElement.Current.Name + "," + automationElement.Current.BoundingRectangle.Width, "");
            //stringBuilder.AppendLine();

            string value = automationElement.Current.AutomationId + "|" + automationElement.Current.Name;
            if (!AutomationIdList.Contains(value))
            {
                AutomationIdList.Add(value);
                WriteDetail(stringBuilder, value + "|" + automationElement.Current.BoundingRectangle.Width, "");
            }
        }
